...
from pydantic import BaseModel, Field
from google import genai
from google.genai import types  # Added for API configuration
from dotenv import load_dotenv
...
Generate a greeting and introduction that previews these articles."""
        ...
        try:
            # Replaced OpenAI's .parse with Gemini's configured generate_content
            ...
            # Use Gemini's built-in parsed accessor
